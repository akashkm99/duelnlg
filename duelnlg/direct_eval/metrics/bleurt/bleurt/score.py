...
flags.DEFINE_integer("bleurt_batch_size", 100, "Number of sentence pairs per batch.")
...
def main(_):
    ...
    score_files(FLAGS.reference_file, FLAGS.candidate_file, FLAGS.bleurt_checkpoint)
